 ...
 * сумма которых равна целевому значению, должен работать корректно: наличие
 * одинаковых чисел, отрицательных чисел, а также сценарии, когда сумма не
 * найдена.</p>
 *
...
class TwoNumberSumTest {
    ...
    /**
     * Проверяет, когда два одинаковых числа в массиве дают нужную сумму.
    ...
    /**
     * Проверяет, когда два одинаковых числа в массиве не дают нужную сумму.
    ...
    /**
     * Проверяет, когда в массиве присутствуют отрицательные числа, и они
     * дают нужную сумму.
    ...
    /**
     * Проверяет, когда в массиве нет отрицательных чисел и сумма равна
     * целевому значению.
