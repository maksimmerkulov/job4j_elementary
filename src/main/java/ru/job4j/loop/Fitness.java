 ...
 * сила Ивана увеличивается в 3 раза, а сила Николая — в 2 раза. Метод {@link #calc(int, int)} вычисляет
 * количество месяцев, за которые сила Ивана превзойдет силу Николая.</p>
 *
...
public class Fitness {
    ...
    /**
     * Вычисляет количество месяцев, которые нужны Ивану, чтобы обогнать Николая по силе тяги.
     *
