 ...
 *
 * <p>Доска представляется в виде сетки, где затемнённые клетки обозначены символом {@code 'X'},
 * а светлые клетки — пробелом. Чередование клеток соответствует шахматному порядку.</p>
 *
 * <p>Метод {@link #paint(int, int)} принимает параметры ширины и высоты доски и выводит её в консоль.</p>
 *
...
public class Board {
     ...
     *
     * <p>Чередование цветов клеток достигается путём проверки чётности суммы индексов строки и столбца.</p>
     *
