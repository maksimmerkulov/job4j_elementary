...
class FindLoopTest {
    ...
    /**
     * Verifies that the method returns {@code -1} when the element
     * is not found.
     */
    @Test
    ...
    /**
     * Verifies that the method returns the correct index when the element
     * is within the range.
     */
    @Test
    ...
    /**
     * Verifies the result when multiple element values exist within
     * the specified range.
     */
    @Test
    ...
    /**
     * Verifies that the method finds the element 2 at index 3
     * within the range.
     */
    @Test
    ...
    /**
     * Verifies if the method returns the correct index when the element
