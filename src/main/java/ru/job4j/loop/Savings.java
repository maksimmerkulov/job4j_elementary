...
/**
 * Класс Savings предназначен для вычисления количества лет, необходимых для накопления целевой суммы
...
public class Savings {
    ...
    /**
     * Метод years рассчитывает количества лет, которые потребуются для накопления заданной суммы
