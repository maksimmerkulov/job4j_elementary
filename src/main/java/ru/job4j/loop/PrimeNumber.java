...
/**
 * Класс {@code PrimeNumber} предназначен для подсчёта количества простых чисел в заданном диапазоне.
 *
...
public class PrimeNumber {
     ...
     *
     * <p>Число 1 не является простым, поэтому оно не учитывается при подсчёте.</p>
     *
