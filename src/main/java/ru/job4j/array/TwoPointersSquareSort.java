...
public class TwoPointersSquareSort {
    ...
    /**
     * Метод обрабатывает массив согласно условию задачи:
    ...
    /**
     * Метод проверяет, содержит ли массив отрицательные числа.
     *
     * @param arr Входной массив.
    ...
    /**
     * Метод разворачивает массив с использованием двух указателей.
     *
     * @param arr Входной массив.
     */
