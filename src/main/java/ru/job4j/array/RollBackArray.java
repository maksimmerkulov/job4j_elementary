 ...
 *
 * <p>Используется при необходимости получить изменённый массив, не затрагивая оригинальный.</p>
 *
...
public class RollBackArray {
    ...
    /**
     * Метод {@code rollback(int[] array)} создаёт новый массив, в котором элементы исходного массива
     * расположены в обратном порядке.
     *
     * <p>Исходный массив остаётся неизменным.</p>
     *
