...
/**
 * Класс {@code ConverterTest} содержит тесты для проверки методов конвертации
 * валют в классе {@link Converter}.
 *
...
class ConverterTest {
    ...
    /**
     * Тестирует метод {@link Converter#rubleToEuro(float)} для конвертации
     * 140 рублей в евро.
    ...
    /**
     * Тестирует метод {@link Converter#rubleToDollar(float)} для конвертации
     * 180 рублей в доллары.
