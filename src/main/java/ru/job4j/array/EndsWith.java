...
/**
 * Класс EndsWith предназначен для проверки, заканчивается ли массив символов на заданный постфикс.
 *
...
public class EndsWith {
    ...
    /**
     * Метод endsWith проверяет, заканчивается ли массив символов word на постфикс postfix.
     *
