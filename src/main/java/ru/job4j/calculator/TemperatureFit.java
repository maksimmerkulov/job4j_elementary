 ...
 *
 * <p>Методы класса вычисляют температуру хранения для разных типов продуктов, уменьшая текущую температуру
 * на фиксированное количество градусов: для фруктов — на 2°C, для мяса — на 5°C.</p>
 *
