...
/**
 * Класс {@code CounterTest} для проверки методов суммирования чисел в классе {@link Counter}.
 *
...
class CounterTest {
    ...
    /**
     * Тест проверяет вычисление суммы чисел от 0 до 10.
    ...
    /**
     * Тест проверяет вычисление суммы чисел от 3 до 8.
    ...
    /**
     * Тест проверяет вычисление суммы чисел в случае, если начальное и конечное число равны 1.
    ...
    /**
     * Тест проверяет вычисление суммы чисел от -5 до 10.
    ...
    /**
     * Тест проверяет случай, когда начальное число больше конечного (10 > 1).
    ...
    /**
     * Тест проверяет вычисление суммы четных чисел от 0 до 10.
    ...
    /**
     * Тест проверяет вычисление суммы четных чисел от 3 до 8.
    ...
    /**
     * Тест проверяет вычисление суммы четных чисел в случае, если диапазон состоит из одного нечетного числа (1).
     * Ожидаемый результат: 0.
     */
    @Test
    ...
    /**
     * Тест проверяет вычисление суммы четных чисел от -5 до 10.
