...
class CheckTest {
    ...
    /**
     * Verifies that the method returns {@code true} when all elements are
     * {@code true}.
     */
    @Test
    ...
    /**
     * Verifies that the method returns {@code false} when elements are mixed.
     */
    @Test
