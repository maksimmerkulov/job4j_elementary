...
/**
 * Класс {@code PrimeNumberTest} предназначен для проверки метода {@link PrimeNumber#calc(int)}
 ...
 *
 * <p><b>В тестах покрываются следующие случаи:</b></p>
 * <ul>
...
class PrimeNumberTest {
    ...
    /**
     * Тест проверяет подсчет простых чисел в диапазоне до 5.
    ...
    /**
     * Тест проверяет подсчет простых чисел в диапазоне до 11.
    ...
    /**
     * Тест проверяет минимальный диапазон с единственным простым числом (2).
    ...
    /**
     * Тест проверяет подсчет простых чисел в диапазоне до 25.
    ...
    /**
     * Тест проверяет подсчет простых чисел в диапазоне до 49.
