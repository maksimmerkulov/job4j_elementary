...
class PointTest {
    ...
    /**
     * Verifies distance between points {@code (0, 0)} and {@code (2, 0)} in
     * two dimensions.
     */
    @Test
    ...
    /**
     * Verifies distance with negative coordinates {@code (-1, -1)} and
     * {@code (1, 1)} in two dimensions.
     */
    @Test
    ...
    /**
     * Verifies the distance between points {@code (0, 0, 0)} and
     * {@code (2, 2, 2)} in three dimensions.
     */
    @Test
    ...
    /**
     * Verifies the distance between points {@code (1, 2, 3)} and
     * {@code (4, 5, 6)} in three dimensions.
     */
    @Test
    ...
    /**
     * Verifies the distance in three dimensions when the points are identical.
     */
    @Test
    ...
    /**
     * Verifies the distance in three dimensions along the Z axis only.
     */
    @Test
