 ...
 *
 * <p>Факториал числа {@code n} определяется как произведение
 * всех натуральных чисел от 1 до {@code n} включительно.</p>
 *
 * <p><b>Определение:</b></p>
 * <ul>
 *     <li>{@code 0! = 1}</li>
...
public class Factorial {
     ...
     *
     * <p>Факториал {@code number} вычисляется как произведение
     * всех целых чисел от 1 до {@code number} включительно.</p>
     *
