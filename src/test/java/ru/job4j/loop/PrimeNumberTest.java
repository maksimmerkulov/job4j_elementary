 ...
 *     <li>Большие значения, например {@code 49}, где проверяется правильность подсчёта на длинном отрезке.</li>
 * </ul>
 *
...
class PrimeNumberTest {
    ...
    /**
     * Проверяет подсчёт простых чисел в диапазоне до 5.
    ...
    /**
     * Проверяет подсчёт простых чисел в диапазоне до 11.
    ...
    /**
     * Проверяет подсчёт простых чисел в диапазоне до 25.
    ...
    /**
     * Проверяет подсчёт простых чисел в диапазоне до 49.
