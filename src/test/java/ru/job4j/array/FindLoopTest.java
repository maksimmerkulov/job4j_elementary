...
/**
 * Класс {@code FindLoopTest} для проверки методов поиска индекса в массиве в классе {@link FindLoop}.
 *
...
class FindLoopTest {
    ...
    /**
     * Тест проверяет, что метод {@link FindLoop#indexOf(int[], int)}
    ...
    /**
     * Тест проверяет, что метод {@link FindLoop#indexInRange(int[], int, int, int)}
