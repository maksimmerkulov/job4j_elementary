 ...
 *
 * <p>Используется {@code жадный алгоритм}: автомат отдает сдачу монетами наибольшего номинала в первую очередь.
 * Доступные номиналы монет: {@code 10, 5, 2, 1}.</p>
 *
...
public class Machine {
     ...
     *
     * <p>Если сумма внесенных денег меньше стоимости товара, метод вернет пустой массив.</p>
     *
